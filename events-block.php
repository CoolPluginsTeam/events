...
define( 'EVENTS_BLOCK_VERSION', '1.0.5.1' );
...
final class EVTB_Events_Block {
	...
	private function __construct() {
		...
		add_action( 'plugins_loaded', array( $this, 'evtb_plugins_loaded' ) );
	...
	public function evtb_plugins_loaded() {
		require_once EVENTS_BLOCK_PATH . 'blocks/evtb-register-blocks.php';
